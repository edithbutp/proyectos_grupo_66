...
public class ClienteDAO {
    ...
    public String mostrarClientes(src.SqliteConnection conexionBD) {
        String salida = "";
        try {
    ...
    public String listarProductosPorCliente(String idenCliente, src.SqliteConnection conexionBD) {
        String salida = "";
