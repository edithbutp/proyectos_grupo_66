...
import src.controlador.ControladorCliente;
import src.modelo.Cliente;

public class Menu {

    public void generarMenu(src.SqliteConnection conexionBD) {
        ...
        switch (opcionElegida) {
            case "1":
                ...
                nuevoCliente.crearCliente(conexionBD);
                break;
            case "2":
                /*Consulta cliente*/
            ...
            case "3":
                ...
                String productos = conexionBD.listarProductosCliente(identCliente);
